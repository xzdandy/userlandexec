...
all: static_dyn_load_run dyn_unmap_run hw env_test margs args2 elfauxv elfauxv_dynamic \
	example ulexec.so

static_dyn_load_run: static_dyn_load_run.c load_elf.o map_file.o libstatic/libstatic.h libstatic/crt.h libstatic/libstatic.a
	gcc -I. -g -Wall -std=gnu99 -nostdlib -fPIC   -c  static_dyn_load_run.c
	gcc -I. -g -std=gnu99 -nostdlib \
		static_dyn_load_run.o map_file.o load_elf.o -o static_dyn_load_run -Llibstatic -lstatic
